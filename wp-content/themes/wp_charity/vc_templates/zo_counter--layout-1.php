<div class="zo-counter-wraper zo-counter-layout-1 <?php echo esc_attr($atts['template']);?>" id="<?php echo esc_attr($atts['html_id']);?>">
	<?php if($atts['title']!=''):?>
                    ...
                    <div class="<?php echo esc_attr($item_class);?>">
                      ...
                      <div class="zo-counter-box" style="color: <?php echo esc_attr($zo_counter_text_color); ?>;">
                          <div class="zo-counter-middle">
                            <div id="counter_<?php echo esc_attr($atts['html_id'].'_item_'.$i);?>" class="zo-counter <?php echo esc_attr(strtolower($type));?>" data-suffix="<?php echo esc_attr($suffix);?>" data-type="<?php echo esc_attr(strtolower($type));?>" data-digit="<?php echo esc_attr($digit);?>">
                            </div>
                          </div>
                      </div>
