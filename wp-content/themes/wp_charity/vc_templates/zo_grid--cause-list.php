...
?>
<div class="zo-grid-wrapper zo-cause-wrapper <?php echo esc_attr($atts['template']); ?>" id="<?php echo esc_attr($atts['html_id']); ?>">
    ...
    <div class="row zo-grid zo-grid-cause <?php echo esc_attr($atts['grid_class']); ?>">
        ...
        while ($posts->have_posts()) :
            ...
            <div class="<?php echo esc_attr($atts['item_class']);?>" data-groups='[<?php echo implode(',', $groups);?>]'>
                <?php get_template_part('single-templates/causes/content','list') ?>
            </div>
        <?php
        endwhile;
        ?>
